...
import commands.CreateCommand2;
...
public class Canvas extends JPanel {
	...
	public Canvas() {
		...
		// x = 100;
		// y = 100;
		// paintableList.add(paintableFactory.create(x, y, x + 100, y + 100,
		// SmileConstants.SMILE_DW));
		//
		// // Face 2
		// x = 200;
		// y = 200;
		// paintableList.add(paintableFactory.create(x, y, x + 100, y + 100,
		// SmileConstants.SMILE_OK));
		//
		// // Face 3
		// x = 300;
		// y = 300;
		// paintableList.add(paintableFactory.create(x, y, x + 100, y + 100,
		// SmileConstants.SMILE_UP));
	...
	protected void clientMousePressed(MouseEvent evt) {
		...
		case PLUGIN:
			...
			redoList.clear();
				...
				CreateCommand2 createCommand = new CreateCommand2( //
						paintableFactory, //
						evt.getPoint().x, evt.getPoint().y, //
						paintableList);
